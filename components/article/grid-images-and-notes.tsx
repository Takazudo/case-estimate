              ...
              >
                {item.blurhash ? (
                  <BlurhashLoader
                    ...
                    alt={item.imageAlt}
                    className="w-full h-full bg-white group-hover:opacity-90 transition-opacity"
                  />
                ) : (
                  <img
                    src={item.thumbUrl}
                ...
                <div className="absolute top-2 right-2 p-1 bg-black bg-opacity-20 rounded opacity-100">
