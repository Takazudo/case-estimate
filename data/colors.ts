...
export const colors: Colors = {
  ...
  '3dp': [
    ...
    { id: 'bright-gold', name: 'ブライトゴールド', value: '#f1c40f', material: 'PLA', opacity: 1 },
    { id: 'deep-gold', name: 'ディープゴールド', value: '#ff9900', material: 'PLA', opacity: 1 },
    ...
    { id: 'silver-gray', name: 'シルバーグレー', value: '#9ca3af', material: 'PLA', opacity: 1 },
    { id: 'silver-white', name: 'シルバーホワイト', value: '#dfe0dd', material: 'PLA', opacity: 1 },
    { id: '3dp-pink', name: 'ピンク', value: '#d4a5b0', material: 'PLA', opacity: 1 },
    { id: 'caramel', name: 'キャラメル', value: '#ab461e', material: 'PLA', opacity: 1 },
  ],
  series: {
    acrylic: [
