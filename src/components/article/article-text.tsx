...
const ArticleText: React.FC<ArticleTextProps> = ({ children, className = '' }) => {
  return (
    <div
      className={`
        article-text text-sm md:text-base ${className}
        
        [&_p]:pb-vgap-md [&_p]:-mt-[0.3em]
        
        [&_ul]:text-sm [&_ul]:lg:text-base [&_ul]:list-disc 
        [&_ul]:pl-hgap-md [&_ul]:pb-vgap-md [&_ul]:-mt-[0.3em]
        [&_ul>*+*]:mt-vgap-xs
        [&_ul_ul]:ml-0 [&_ul_ul]:mt-vgap-sm [&_ul_ul]:pb-vgap-xs
        
        [&_ol]:text-sm [&_ol]:lg:text-base [&_ol]:list-decimal 
        [&_ol]:ml-hgap-md [&_ol]:pb-vgap-md [&_ol]:-mt-[0.3em]
        [&_ol>*+*]:mt-vgap-xs
