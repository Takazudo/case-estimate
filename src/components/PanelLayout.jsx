...
const PanelLayout = ({ caseType, panelColors, onPanelClick, selectedPanel }) => {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      <div
        className="relative"
        style={{ width: `${panelWidth + sideWidth * 2 + gap * 4}px`, height: '600px' }}
      >
        {/* Top row */}
        {renderPanel(
          'top-front',
          is60hp ? '60hp-front-back-top' : '40hp-front-back-top',
        ...
        {renderPanel(
          ...
          is60hp ? '60hp-bottom' : '40hp-bottom',
          {
            top: `${(topHeight + gap) * 2 + centerHeight + gap}px`,
            left: '50%',
        ...
        {renderPanel(
          'bottom-front',
          is60hp ? '60hp-front-back-bottom' : '40hp-front-back-bottom',
